...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  // 20. Foreign Keys (Note: PostgreSQL does NOT support IF NOT EXISTS for ADD CONSTRAINT)
  await exec(db, `ALTER TABLE ONLY "projects" ADD CONSTRAINT "projects_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE SET NULL;`)
  await exec(db, `ALTER TABLE ONLY "projects" ADD CONSTRAINT "projects_cover_image_id_media_id_fk" FOREIGN KEY ("cover_image_id") REFERENCES "media"("id") ON DELETE SET NULL;`)
  await exec(db, `ALTER TABLE ONLY "projects_gallery" ADD CONSTRAINT "projects_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "media"("id") ON DELETE SET NULL;`)
  await exec(db, `ALTER TABLE ONLY "projects_gallery" ADD CONSTRAINT "projects_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "projects"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "projects_texts" ADD CONSTRAINT "projects_texts_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "projects"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "services_badges" ADD CONSTRAINT "services_badges_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "services"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "settings" ADD CONSTRAINT "settings_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "media"("id") ON DELETE SET NULL;`)
  await exec(db, `ALTER TABLE ONLY "settings_social_links" ADD CONSTRAINT "settings_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "settings"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "settings_stats" ADD CONSTRAINT "settings_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "settings"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "testimonials" ADD CONSTRAINT "testimonials_photo_id_media_id_fk" FOREIGN KEY ("photo_id") REFERENCES "media"("id") ON DELETE SET NULL;`)
  await exec(db, `ALTER TABLE ONLY "users_sessions" ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "users"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "payload_locked_documents"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "users"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "media"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_projects_fk" FOREIGN KEY ("projects_id") REFERENCES "projects"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "categories"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_services_fk" FOREIGN KEY ("services_id") REFERENCES "services"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_testimonials_fk" FOREIGN KEY ("testimonials_id") REFERENCES "testimonials"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "payload_preferences"("id") ON DELETE CASCADE;`)
  await exec(db, `ALTER TABLE ONLY "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "users"("id") ON DELETE CASCADE;`)
}
